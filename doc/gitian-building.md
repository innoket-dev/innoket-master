...
*Setup instructions for a gitian build of Innoket using a Debian VM or physical system.*
...
- [Building Innoket](#building-innoket)
...
git clone https://github.com/ALPHANODE/Innoket.git
cd innoket
...
To build Innoket (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/ALPHANODE/Innoket
...
For example:
```bash
URL=https://github.com/ALPHANODE/Innoket
