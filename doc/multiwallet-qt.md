...
In order to support loading of multiple wallets in innoket-qt, a few changes in the UI architecture will be needed.
...
----------------------
innoket.cpp is the entry point into innoket-qt, and as such, will require some minor modifications to provide hooks for
