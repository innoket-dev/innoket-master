/* src/config/innoket-config.h.  Generated from innoket-config.h.in by configure.  */
/* src/config/innoket-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.innokets"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Innoket Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Innoket Core 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "innoket"
