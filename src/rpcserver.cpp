...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"innoket", "masternodelist", &masternodelist, true, true, false},
        {"innoket", "mnbudget", &mnbudget, true, true, false},
        {"innoket", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
...
#ifdef ENABLE_WALLET
        {"innoket", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use innoketd, or the -server option to innoket-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37659/\n";
}
